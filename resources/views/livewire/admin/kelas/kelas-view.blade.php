...
<section class="section">
    <div class="section-header">
        ...
        <h1>{{ $formAdd ? 'Tambah Kelas' : 'Edit Kelas' }}</h1>
    </div>
    ...
    <div class="section-body">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header"><h4>Form Kelas</h4></div>
                    <div class="card-body">
                        <form wire:submit.prevent="{{ $formAdd ? 'add' : 'update' }}" autocomplete="off">
                            <!-- ID Kelas -->
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">ID Kelas</label>
                                <div class="col-sm-12 col-md-7">
                                    <input type="text" class="form-control" wire:model.defer="id_kelas">
                            ...
                            <!-- Deskripsi -->
                            <div class="form-group row mb-4">
                                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Deskripsi Kelas</label>
                                <div class="col-sm-12 col-md-7">
