                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <h4>Data Penggajian Periode: <span class="badge badge-primary">{{ $bulan }}/{{ $tahun }}</span></h4>
                                    
                                    <button wire:click="$set('formTgl', true)" class="btn btn-warning btn-lg float-right">
                                ...
                                <table class="table table-bordered"
                                    ...
                                    <tbody>
                                        @foreach($penggajians as $index => $gaji)
                                            <tr>
                                                <td style="border: 1px solid #000; padding: 8px;" class="text-center">
                                                    {{ $index + 1 }}</td>
                                                <td style="border: 1px solid #000; padding: 8px;">{{ $gaji->tutor->nama }}</td>
                                                <td style="border: 1px solid #000; padding: 8px;" class="text-center">
                                                    {{ $gaji->total_pertemuan }}</td>
                                                <td style="border: 1px solid #000; padding: 8px;" class="text-center">
                                                    {{ $gaji->total_durasi}}</td>
                                                <td style="border: 1px solid #000; padding: 8px;" class="text-center">
                                                    {{ $gaji->status_pembayaran }}</td>
                                                <td style="border: 1px solid #000; padding: 8px;" class="text-right">Rp
                                                    {{ number_format($gaji->total_honor, 0, ',', '.') }}
                                                </td>
                                            </tr>
                                        @endforeach
                                    ...
                                    <tfoot>
                                        <tr style="background-color: #ddd;">
                                            <td colspan="5" style="border: 1px solid #000; padding: 8px;"
                                                class="text-right font-bold">TOTAL PENGELUARAN</td>
                                            <td style="border: 1px solid #000; padding: 8px;" class="text-right font-bold">
                                                Rp{{ number_format($penggajians->sum('total_honor'), 0, ',', '.') }}
                                            </td>
                                        </tr>
                                    </tfoot>
                                </table>
